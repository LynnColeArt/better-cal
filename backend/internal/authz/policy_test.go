...
func TestPolicyConstantsExistInContractRegistry(t *testing.T) {
	...
	for _, policy := range []Policy{
		...
		PolicyAppsRead,
		PolicyAppsInstall,
		PolicyAppInstallIntentsRead,
		PolicyAppInstallIntentsHandoff,
		PolicyAppInstallExternalAuthRead,
		PolicyAppInstallExternalAuthConsume,
		PolicyAppInstallExternalAuthPreview,
		PolicyAppInstallExternalAuthCallback,
		PolicyAppInstallProviderExchange,
		PolicyAppInstallComplete,
		PolicyAppInstallActivate,
		PolicyAppInstallationsRead,
		PolicyAppInstallProgressRead,
		PolicyBookingRead,
		PolicyBookingWrite,
		PolicyBookingHostAction,
		PolicySlotsRead,
		PolicyCalendarConnectionsRead,
		PolicyCalendarsRead,
		PolicyCredentialsRead,
		PolicySelectedCalendarsRead,
		PolicySelectedCalendarsWrite,
		PolicyDestinationCalendarsRead,
		PolicyDestinationCalendarsWrite,
	} {
