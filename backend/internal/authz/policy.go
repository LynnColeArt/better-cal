...
const (
	...
	PolicyAppInstallIntentsRead          Policy = "policy.app-install-intents.read"
	PolicyAppInstallIntentsHandoff       Policy = "policy.app-install-intents.handoff"
	PolicyAppInstallExternalAuthRead     Policy = "policy.app-install-intents.external-auth.read"
	PolicyAppInstallExternalAuthConsume  Policy = "policy.app-install-intents.external-auth.consume"
	PolicyAppInstallExternalAuthPreview  Policy = "policy.app-install-intents.external-auth.authorization-preview"
	PolicyAppInstallExternalAuthCallback Policy = "policy.app-install-intents.external-auth.callback-preflight"
	PolicyAppInstallProviderExchange     Policy = "policy.app-install-intents.external-auth.provider-exchange"
	PolicyAppInstallComplete             Policy = "policy.app-install-intents.complete"
	PolicyAppInstallActivate             Policy = "policy.app-install-intents.activate"
	PolicyAppInstallationsRead           Policy = "policy.app-installations.read"
	PolicyAppInstallProgressRead         Policy = "policy.app-install-intents.progress.read"
...
func NewAuthorizer() *Authorizer {
	return &Authorizer{
		requiredPermissions: map[Policy][]string{
			...
			PolicyAppInstallIntentsRead:          {"apps:read"},
			PolicyAppInstallIntentsHandoff:       {"apps:install"},
			PolicyAppInstallExternalAuthRead:     {"apps:install"},
			PolicyAppInstallExternalAuthConsume:  {"apps:install"},
			PolicyAppInstallExternalAuthPreview:  {"apps:install"},
			PolicyAppInstallExternalAuthCallback: {"apps:install"},
			PolicyAppInstallProviderExchange:     {"apps:install"},
			PolicyAppInstallComplete:             {"apps:install"},
			PolicyAppInstallActivate:             {"apps:install"},
			PolicyAppInstallationsRead:           {"apps:read"},
			PolicyAppInstallProgressRead:         {"apps:install"},
