...
func TestMigrateIsIdempotent(t *testing.T) {
	...
	for _, tableName := range []string{"booking_fixtures", "bookings", "booking_attendees", "booking_planned_side_effects", "api_key_principals", "oauth_clients", "platform_clients"} {
		var exists bool
