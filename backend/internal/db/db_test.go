...
func TestMigrateIsIdempotent(t *testing.T) {
	...
	for _, tableName := range []string{"booking_fixtures", "bookings", "booking_attendees", "booking_planned_side_effects", "booking_side_effect_dispatch_log", "booking_webhook_deliveries", "booking_webhook_subscriptions", "booking_webhook_delivery_attempts", "booking_email_deliveries", "booking_email_delivery_attempts", "booking_calendar_dispatches", "booking_calendar_dispatch_attempts", "calendar_connections", "calendar_catalog", "calendar_connection_status_history", "selected_calendars", "destination_calendars", "api_key_principals", "oauth_clients", "platform_clients"} {
		var exists bool
