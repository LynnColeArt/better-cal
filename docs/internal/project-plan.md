...
- atomic authorization code consumption; started with the fixture authorization-code exchange canary, refresh-token rotation canary, replay-denial tests, and hashed access-token authentication tests for booking reads;
